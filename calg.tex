...
\begin{document}
	...
	\begin{enumerate}
      \item[11a] Proposizione 3.1.1: $A$ anello, allora le seguenti affermazioni
        ...
        \begin{enumerate}
          \item Ogni famiglia non vuota di ideali di $A$ ha un elemento
            ...
            relazione di $\subset$}.
          \item Ogni catena ascendente di ideali di $A$ $\left\{ I_k
            \right\}_{k\in \Gamma}$ è stazionario, ovvero
            \begin{equation*}
              I_1 \subseteq I_2 \subseteq \subseteq \dots \subseteq I_{n+1}
              = I_{n+1} = \dots 
            \end{equation*}
            per un certo $n > 1$.
      ...
      \item[11a-b] Dimostrazione della Proposizione 3.1.1.
      \item[11b] Esercizio: Sia $A$ noetheriano $I \subset A$
        ideale di $A$, allora $A/I$ è noetheriano.
      \item[11c] Esempio di anello non noetheriano (Esempio 3.1.1).
      \item[11c] Esempio 3.2.1: anello di polinomi $\mathbb{K}\left[ x,y \right]$,
      ...
      \item[11c] Storia dell'algebra commutativa, teorema della base di Hilbert
        e sviluppi da parte di Noether e Krull.
	\end{enumerate}   
